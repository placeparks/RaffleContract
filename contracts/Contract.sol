...
contract MyContract {
    ...
    function startRaffle(address _nftContract, uint256 _tokenID) public onlyOwner {
        ...
        require(nftAddress == address(0), "NFT prize is already set");
        require(
...
function selectWinner() public onlyOwner{
    require(!raffleStatus, "Raffle is not ended");
    ...
    emit WinnerSelected(winner);
        ERC721Base(nftAddress).safeTransferFrom(owner, winner, nftId);
resetEntryCounts();
